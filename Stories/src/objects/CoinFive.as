package objects
{
	...
	public class CoinFive extends Sprite
	{
		...
		public function CoinFive()
		{
			coinBtn = new Button(Assets.getTexture("CoinBtn"));
			coinBtn.scale = 0.5;
			coinBtn.x = int((Constant.STAGE_WIDTH_COIN_5 - coinBtn.width) / 2);
			coinBtn.y = Constant.STAGE_HEIGHT_COIN_5 * 0.75;
		...
		private function onClick(event:TouchEvent):void {
			...
			if (touch) {
				...
				coinBlick.x = int((Constant.STAGE_WIDTH_COIN_BLICK_FIVE - coinBlick.width) / 2);
				coinBlick.y = Constant.STAGE_HEIGHT_COIN_BLICK_FIVE * 0.75;
				this.addChild(coinBlick);
				
				trace("Coin five is pressed");
			}
		}
	}
}