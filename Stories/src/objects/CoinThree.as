package objects
{
	...
	public class CoinThree extends Sprite
	{
		...
		public function CoinThree()
		{
			
			coinBtn = new Button(Assets.getTexture("CoinBtn"));
			coinBtn.scale = 0.5;
			coinBtn.x = int((Constant.STAGE_WIDTH_COIN_3 - coinBtn.width) / 2);
			coinBtn.y = Constant.STAGE_HEIGHT_COIN_3 * 0.75;
		...
		private function onClick(event:TouchEvent):void {
			...
			if (touch) {
				...
				coinBlick.x = int((Constant.STAGE_WIDTH_COIN_BLICK_THREE - coinBlick.width) / 2);
				coinBlick.y = Constant.STAGE_HEIGHT_COIN_BLICK_THREE * 0.75;
				this.addChild(coinBlick);
				
				trace("Coin three is pressed");
			}
		}
	}
}